...
A filterable table showing the balance of every account in your ledger. Filter by account name, type, or commodity to find what you need.
...
Advanced filtering of individual postings by:
- Account name or pattern
- Transaction type
- Commodity
- Date range
- Tags
...
Full-text search across all transactions in your vault. Matches against descriptions, account names, comments, and tags.
